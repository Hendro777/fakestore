...

  {
    return (
      <div className="product">
        <NavLink to={props.item.id.toString()} className="navlink">
          ...
          <div className="info">
            ...
            <ProductRating rating={props.item.rating}></ProductRating>
            ...
            <div className="pricing">
              <span className="price">
                {Number(
                  props.item.price *
                    ((100 - props.item.discountPercentage) / 100)
                ).toFixed(0)}
                €
              </span>
              <span className="rrp">
                RRP: <span className="value">{props.item.price}€</span>
              </span>
            </div>
            {props.item.stock <= 0 ? (
        ...
        {props.item.stock > 0 && (
          <button
            onClick={() => addToCart(props.item.id, 1)}
            type="button"
